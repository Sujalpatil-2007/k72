...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex fixed top-0 w-full items-start justify-between z-3 '>
        <div className="lg:p-3 p-2">
            <div className=" lg:w-31 w-25 ">
        ...
        onClick={()=>{
         ...
         onMouseEnter={()=>{
            ...
            navLineRef.current.style.color = 'black'
        }}
        onMouseLeave={()=>{
            navGreenRef.current.style.height = '0%'
            navLineRef.current.style.color = 'white'
        }}  className="  cursor-pointer  lg:h-13 h-11 bg-black relative lg:w-59 w-45 ">
            <div ref={navGreenRef} className=" h-0 bg-[#D3FD50] transition-all absolute top-0 w-full ">
                <div ref={navLineRef} className="flex flex-col lg:px-1 px-5 py-1.5 leading-2.5">
                    <div className="flex items-center justify-end">
                        <h1 className='font-bold text-2xl bg-transparent leading-1.5'>______</h1>
                    </div>
                    <div className="flex items-center justify-end">
                        <h1 className='font-bold text-2xl leading-1.5'>___</h1>
                    </div>
                </div>
            </div>
